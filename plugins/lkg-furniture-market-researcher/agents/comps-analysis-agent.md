...
Use available web search only when institutional data connectors are unavailable or when searching public sources such as ASX releases, annual reports, investor pages, ABS datasets, and reputable news. Document source URLs, periods, and assumptions.
